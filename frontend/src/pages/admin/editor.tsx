  ...
  return (
    <AdminLayout title="에디터">
      <div className="h-[calc(100vh-64px)] flex flex-col">
        ...
        {selectedObject && (
          <div className="md:hidden fixed left-0 right-0 z-[55] max-h-[40vh] overflow-y-auto bg-white dark:bg-[#1a1a1a] border-t border-gray-200 dark:border-gray-700 shadow-lg rounded-t-xl px-3 py-2" style={{ bottom: '56px' }}>
